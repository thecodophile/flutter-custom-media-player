      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Some dummy surrounding UI to show how it could look in an app
           /* Expanded(
              child: Container(
                ...
                child: ListView(
                  children: [
                    Text(
                      'Big Buck Bunny (Dummy)',
                      style: theme.textTheme.titleLarge,
                    ),
                    const SizedBox(height: 8),
                    Text(
                      'This is a lightweight demo using the `video_player` package. '
                          'Controls include play/pause, 10s skip, mute, speed, and a progress bar.',
